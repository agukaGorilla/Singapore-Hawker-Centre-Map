...
const regionBoundaries = {
  "Central": {
    color: "#3b82f6", // Blue
    coords: [[1.26, 103.79], [1.34, 103.80], [1.34, 103.87], [1.29, 103.87], [1.26, 103.83]]
  },
  "East": {
    color: "#10b981", // Green
    coords: [[1.29, 103.87], [1.34, 103.87], [1.40, 103.92], [1.40, 104.02], [1.29, 104.02]]
  },
  "North": {
    color: "#ef4444", // Red
    coords: [[1.40, 103.75], [1.48, 103.75], [1.48, 103.85], [1.40, 103.85]]
  },
  "West": {
    color: "#f59e0b", // Orange
    coords: [[1.22, 103.62], [1.45, 103.62], [1.40, 103.75], [1.34, 103.80], [1.26, 103.79], [1.22, 103.70]]
  },
  "North-East": {
    color: "#8b5cf6", // Purple
    coords: [[1.34, 103.87], [1.40, 103.92], [1.45, 103.85], [1.34, 103.85]]
  }
};
